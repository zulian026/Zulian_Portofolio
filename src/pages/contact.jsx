...
function Contact() {
  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/zulian026",
    },
    {
      name: "LinkedIn",
      icon: (
      ...
      url: "https://linkedin.com/in/zulian-alhisyam-175414363",
    },

    {
      ...
      url: "https://www.instagram.com/zyanx_04",
    },
  ];
  ...
  return (
    <div
      ...
      className="py-24 md:py-32 px-6 md:px-10 lg:px-16 overflow-hidden relative"
    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-gray-900 border border-gray-800 focus:border-pink-400 text-white rounded-lg p-3 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-pink-400/20"
                    placeholder="zulianalhisyam@gmail.com"
                  />
                </div>
              </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:zulianalhisyam@gmail.com"
