...
function Projects() {
  // Expanded project data with more projects and GitHub URLs
  const allProjectData = [
    ...
    },
    {
      ...
      imageUrl: "/images/zulian1.jpg", // Using placeholder images
      githubUrl: "https://github.com/username/video-streaming-service",
    },
  ];
...
// Enhanced Gallery-Style Project Card Component with GitHub Button
  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden rounded-2xl mb-6 aspect-[16/10] relative shadow-xl">
        ...
        {/* Call to action buttons with improved animation */}
        <div className="absolute inset-0 bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-500 flex items-center justify-center gap-4">
          ...
          <motion.a
            ...
            transition={{
              duration: 0.4,
              ease: "easeOut",
              delay: 0.05, // Small delay for staggered appearance
            }}
