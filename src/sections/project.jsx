  ...
  const projectData = [
    {
      ...
      year: "2025",
      description:
        "TaskNet is a task management app that helps users organize activities, set priorities, and stay productive, both individually and in teams.",
      technologies: ["React", "Mysql", "Laravel"],
      imageUrl: "/images/Project 1.png", // Using placeholder images
      githubUrl: "https://github.com/zulian026/TaskNest", // Added GitHub URL
      projectUrl: "/project/1", // Add project detail URL
    },
    // {
    //   id: 2,
...
const ViewAllButton = ({ animation, onNavigate }) => {
  return (
    <motion.div className="flex justify-center mt-20" {...animation}>
      <motion.button
        className="group relative px-10 py-4 bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-full overflow-hidden shadow-lg shadow-pink-500/20 cursor-pointer border-none"
      ...
      <div className="overflow-hidden rounded-2xl mb-6 aspect-[16/10] relative shadow-xl">
        {!imageError ? (
          <motion.div className="relative w-full h-full">
            ...
            {/* Action buttons container - Fixed positioning and z-index */}
            <motion.div
              className="absolute inset-0 flex items-center justify-center gap-4 z-20"
              animate={cardAnimations.buttonsContainer}
            >
              {/* View Project button */}
              <motion.button
                className="bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold px-6 py-3 rounded-full shadow-lg shadow-pink-500/30 border-none cursor-pointer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              ...
              {/* GitHub button */}
              <motion.button
                className="bg-gray-900 border border-pink-400/30 text-white font-bold px-6 py-3 rounded-full shadow-lg shadow-gray-900/30 flex items-center gap-2 cursor-pointer"
                whileHover={{
                  scale: 1.05,
          ...
          <div className="w-full h-full flex items-center justify-center text-pink-400 bg-gray-800 rounded-2xl">
